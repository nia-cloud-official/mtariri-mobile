    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              <div class="dropdown-title"><?php echo $user_data['username'];?></div>
              <a href="profile.html" class="dropdown-item has-icon"> <i class="far
										fa-user"></i> Profile
              </a> <a href="timeline.html" class="dropdown-item has-icon"> <i class="fas fa-envelope"></i>
                My Inbox
              </a>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="#"><i data-feather="file"></i><span>My Plans</span></a></li>
            <li><a class="nav-link" href="#"><i data-feather="smile"></i><span>My Companion</span></a></li>
          </ul>
        </aside>
      </div>
      <!-- Main Content -->
        ...
        <section class="section">
          ...
          <div class="row">
            <div class="col-md-6 col-lg-12 col-xl-6">
              <!-- Companion Bot Here!!!s -->
              <div class="card">
                <div class="card-header">
                  <h4>Companion Bot Here!!!</h4>
                </div>
                <a href="javascript:void(0)" class="card-footer card-link text-center small ">Coming Soon!</a>
              </div>
              <!-- Companion Bot Here!!!s -->
            </div>
          </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
          <a href="www.mtariri.co.za">Mtariri Life Assurance</a></a>
        </div>
