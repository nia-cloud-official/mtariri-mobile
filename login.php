...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    <div class='error-alert'>
      <div class='flex'>
        ...
        <div class='error-prompt-container'><div class='error-prompt-wrap'>
            <ul class='error-prompt-list' role='list'>
              <li>Make sure to enter your email!</li>
            </ul>
        </div>
        </div>
      </div>
...
<body>
  ...
  <div class="input_container">
    ...
    <input placeholder="name@mail.com" title="Inpit title" name="input-name" name="email" type="text" class="input_field" id="email_field">
  </div>
  <div class="input_container">
    ...
    <input placeholder="Password" title="Inpit title" name="input-name" name="password" type="password" class="input_field" id="password_field">
  </div>
